            ...
            <div className="aboutPage" >
                <div className="card">
                    <div className="card-body">
                        ...
                        <p className="card-text">Hello, my name is Zach LaFleur and I am an aspiring web developer. I have made it through a 6 month bootcamp for computer programming and web development at the University of Utah run by Trilogy. My skills include: HTML, CSS, JS, NODEJS, React and so much more.</p>
